 ...
 */
        ...
        public:
             ...
             */
            static ImageProcess *
            create(const ImageFormat sourceFormat = RGBA, const ImageFormat destFormat = RGBA,
                   const float *means = nullptr, const int meanCount = 0,
             ...
             */
            ErrorCode
            convert(const uint8_t *source, int iw, int ih, int stride, void *dest, int ow, int oh,
                    int outputBpp = 0,
            ...
            static Tensor *
            createImageTensor(halide_type_t type, int w, int h, int bpp, void *p = nullptr);
