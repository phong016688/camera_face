...
*/
        ...
        public:
            ...
            */
            static Matrix
            MakeAll(float scaleX, float skewX, float transX, float skewY, float scaleY,
                    float transY, float pers0,
            ...
            */
            void
            setAll(float scaleX, float skewX, float transX, float skewY, float scaleY, float transY,
                   float persp0,
        ...
        private:
            ...
            */
            ...
            typedef void (*MapPtsProc)(const Matrix &mat, Point dst[], const Point src[],
                                       int count);
