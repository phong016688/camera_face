...
class PreviewViewCustom(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    fun drawRect(listRect: List<Rect>) {
        isClear = false
        rects.clear()
        rects.addAll(listRect)
        invalidate()
    }
